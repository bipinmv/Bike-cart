...
else
{
 ...
 if(isset($_GET["added"]))
    echo '<script type="text/javascript">alert("One Item Added To Cart")</script>';
	}
?>
<html lang="en">
  <head>
	...
	<div class="topNav">
		<div class="container">
			<div class="alignR">
				...
				<a class="active" href="userhomepage.php"> <span class="icon-home"></span> Home</a> 
	...
	-->
		<div class="well well-small">
		  ...
		  ?>
			<li class="span4">
			  <div class="thumbnail">
				<a  href="product_details.php?id=<?php echo $row[0];?>" title="Quick View"><span class="icon-search"></span> QUICK VIEW</a><a  href="product_details.php?id=<?php echo $row[0];?>">
                <img src="<?php echo $row[5];?>" alt=""></a></a>
				<div class="caption">
			        <p><?php echo $row[2];?> </p>
                    <p><?php echo $row[1];?></p>
                    <?php  $productid = $row[0]; ?>
...
<section class="our_client">
	...
	<div class="row">
		...
		<div class="span2">
			<a ><img src="assets/images/ceat logo.png"></a>		</div>
		<div class="span2">
			<a ><img src="assets/images/re logo.png"></a>		</div>
		<div class="span2">
			<a ><img src="assets/images/hero logo.png"></a>		</div>
		<div class="span2">
			<a ><img src="assets/images/honda logo.png"></a>		</div>
        <div class="span2">
