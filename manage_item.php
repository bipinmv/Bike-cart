...
?>      </td>
    <td>
      <img src="<?php echo $reg[5]; ?> " width="200" height="200"/>
      </td>

      <td>
        <a href="del_item.php?id=<?php echo $reg[0];?>" >DELETE</a>
        <a href="edit_item.php?id=<?php echo $reg[0];?>" > <input type="button" name="EDIT" value="Edit" /> </a>      </td> 
    </td>
    </tr>
    <?php
}
